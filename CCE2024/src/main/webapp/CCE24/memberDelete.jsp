...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 회원정보 삭제 비밀번호 확인</title>
		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><a href="myRecords.jsp" style="color:black;">나의 탐험 정보</a> > 회원 탈퇴 비밀번호 확인</h2>
				</div>
				<!-- 세션 정보 받아오기 -->
				<%
				...
				<div style="height:500px;">
					<form name="delMember" action="memberDelAction.jsp?userID=<%=sessionID %>" method="post">
...
<script>
	function checkCPass(){
		if(document.delMember.password.value==""){
			Swal.fire(
					'비밀번호 입력 오류!',
					"비밀번호를 입력해주세요.",
					'warning');
			document.delMember.password.focus();
			return false;
		}
