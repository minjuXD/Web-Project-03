...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 추천글 관리 페이지</title>
				...
				<div style="height:500px;">
					<%
						...
						if (msg != null){ 
							...
							//글 수정
							if (msg.equals("0"))
								out.println("<script>Swal.fire('추천글 수정 완료!','추천글 수정이 완료되었습니다.','success').then(function() { location.href='boardList.jsp'; });</script>");
							
							//글 등록
							else if (msg.equals("1")) 
								out.println("<script>Swal.fire('추천글 등록 완료!', '추천글 등록이 완료되었습니다.', 'success').then(function() { location.href='boardList.jsp'; });</script>");
							...
							//비밀번호 오류
								...
								out.println("<script>Swal.fire('비밀번호 오류!','비밀번호가 일치하지 않습니다. 다시 입력해보세요.','warning').then(function() { location.href='boardList.jsp'; });</script>");
							
						}else { 
							//글 삭제
							out.println("<script>Swal.fire('추천글 삭제 완료!','추천글 삭제가 완료되었습니다.','success').then(function() { location.href='boardList.jsp'; });</script>");
						}
					%>
				</div>
