		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><a href="myRecords.jsp" style="color:black;">나의 탐험 정보</a> > 내가 작성한 추천글 모아보기</h2>
				</div>
				<!-- 세션 정보 받아오기 -->
				<%
				...
				<div style="height:500px;">
					<%
						...
						String sql="select count(*) from CCE24BOARD where userID=?";
					...
					<div id="boardTable">
						<table class="table table-hover text-center">
							...
							<%
								try{
									sql="select boardID,title,regDate,bView from CCE24BOARD where userID=? order by boardID desc";
									pstmt=conn.prepareStatement(sql);
									pstmt.setString(1, sessionID);
									rs=pstmt.executeQuery();
							...
							<tr>
								...
								<td><%=bView %></td>
								<td>
									<input type="button" class="fs-6 p-1 ms-2 btn btn-outline-dark" style="width:100px;" value="글 보러가기" onclick="location='boardView.jsp?boardID=<%=boardID %>'">
								</td>
							</tr>
							<% 
								}}catch(Exception e){
