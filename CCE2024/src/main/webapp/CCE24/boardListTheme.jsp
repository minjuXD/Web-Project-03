			        ...
			        <%
			            ...
			            try {
			                if (sortTheme == null) {
			                    ...
			                    <div id="sortingBoard">
			                        <form name="sortingBoard" action="boardThemeAction.jsp" method="post">
			                        	<div class="d-inline-flex border rounded-3 pt-3 bg-primary-subtle">
				                        	<div class="mx-3 fs-5">
				                        		<p>테마 선택 : </p>
				                        	</div>
				                            <div id="sortTheme" class="input-group mb-3" style="width:200px;">
				                                <select name="sortTheme" class="form-select me-2">
				                            ...
				                            <div class="ms-1">
				                                ...
				                                <input type="reset" class="fs-6 p-1 me-2 btn btn-outline-dark pull-left" style="width:70px;" style="width:70px;" value="취소">
				                            </div>
				                        </div>
				                    </form>
				                </div>
			                    ...
			                    sql = "select count(*) from CCE24BOARD where theme=?";
			                    pstmt = conn.prepareStatement(sql);
			                    pstmt.setString(1, sortTheme);
			                    rs = pstmt.executeQuery();
			                    ...
			                    <div id="boardTable" class="mt-4">
			                        <table class="table table-hover text-center">
			                            ...
			                            <%
			                                sql = "select a.boardID,a.title,a.userID,a.regDate,a.bView,b.mebType from CCE24BOARD a, CCE24MEMBER b where a.userID=b.userID and a.theme=? order by boardID desc";
			                                pstmt = conn.prepareStatement(sql);
			                                pstmt.setString(1, sortTheme);
			                                rs = pstmt.executeQuery();
