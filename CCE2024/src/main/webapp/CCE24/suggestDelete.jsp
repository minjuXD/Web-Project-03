...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 건의사항 삭제 비밀번호 확인</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<%
				...
				try{
					String sql="select userID from CCE24SUGGEST where suggestID=?";
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><span class="text-decoration-underline"><%=suggestID %>번 건의사항</span> 삭제 비밀번호 확인</h2>
				</div>
				<div style="height:500px;">
					<form name="delBoard" action="suggestDelAction.jsp?suggestID=<%=suggestID %>" method="post">
						<div id="checkCPass" class="input-group mb-3" style="width:200px;">
							<input type="password" class="form-control" id="sPass" name="sPass">
						</div>
						<div class="mb-3">
...
<script>
	function checkCPass(){
		if(document.delBoard.sPass.value==""){
			Swal.fire(
					'비밀번호 입력 오류!',
					"비밀번호를 입력해주세요.",
					'warning');
			document.delBoard.sPass.focus();
			return false;
		}
