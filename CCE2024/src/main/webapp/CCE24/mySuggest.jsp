		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><a href="myRecords.jsp" style="color:black;">나의 탐험 정보</a> > 내가 작성한 건의사항 글 모아보기</h2>
				</div>
				<!-- 세션 정보 받아오기 -->
				<%
				...
				<div style="height:500px;">
					<%
						...
						String sql="select count(*) from CCE24SUGGEST where userID=?";
					...
					<div id="boardTable">
						<table class="table table-hover text-center">
							...
							<%
								try{
									sql="select suggestID,sTitle,sRegDate,sView from CCE24SUGGEST where userID=? order by suggestID desc";
									pstmt=conn.prepareStatement(sql);
									pstmt.setString(1, sessionID);
									rs=pstmt.executeQuery();
									...
									while(rs.next()){
										...
										String sRegDate=rs.getString(3);
										String sView=rs.getString(4);
										%>
							...
							<tr>
								...
								<td><%=sView %></td>
								<td>
									<input type="button" class="fs-6 p-1 ms-2 btn btn-outline-dark" style="width:100px;" value="글 보러가기" onclick="location='suggestView .jsp?suggestID=<%=suggestID %>'">
								</td>
							</tr>
							<% 
								}}catch(Exception e){
