...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 탐험가 회원 가입 페이지</title>
				...
				<div>
					...
					<!-- 멤버 타입 선택 -->
						<div class="btn-group mb-3" role="group">
							<input type="radio" class="btn-check" id="exp" name="mebType" value="exp" checked>
					...
					<!-- 공통 항목 입력 부분 -->
						<div id="common">
							...
							<div id="comAddr" class="input-group mb-3">
								...
								<input type="button" class="btn btn-outline-dark fs-6 p-1 me-2 " onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
