...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 댓글 삭제 비밀번호 확인</title>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<%
				...
				try{
					String sql="select userID,boardID from CCE24COMMENT where commentID=?";
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><span class="text-decoration-underline"><%=boardID %>번 추천글</span>의 <span class="text-decoration-underline"><%=commentID %>번 댓글</span> 삭제 비밀번호 확인</h2>
				</div>
				<div style="height:500px;">
					<form name="delComment" action="commentDelAction.jsp?commentID=<%=commentID %>" method="post">
...
<script>
	function checkCPass(){
		if(document.delComment.cPass.value==""){
			Swal.fire(
					'비밀번호 입력 오류!',
					"비밀번호를 입력해주세요.",
					'warning');
			document.delComment.cPass.focus();
			return false;
		}
