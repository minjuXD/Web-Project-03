...
<head>
<meta charset="UTF-8">
<title>우리 동네 카페 탐험기 - 탐험가 회원 정보 수정 페이지</title>
		...
		<div class="row">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom page">
					<h2><a href="myRecords.jsp" style="color:black;">나의 탐험 정보</a> > 탐험가 회원 정보 수정</h2>
				</div>
				<div>
					<%
						String sql="";
						try{
							sql="select userName,gender,birth,email,phone,address,theme,postcode,extraAddr,detailAddr,preferDrk,preferDst from CCE24MEMBER where userID=?";
					...
					<!-- 멤버 타입 선택 -->
						<div class="btn-group mb-3" role="group">
							<input type="radio" class="btn-check" name="mebType" id="exp" name="mebType" value="exp" checked>
							<label class="btn btn-outline-dark" for="exp"> 🤠탐험가</label>
							<input type="radio" class="btn-check" id="nat" name="mebType" value="nat" disabled>
